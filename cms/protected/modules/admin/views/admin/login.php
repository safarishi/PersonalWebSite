...
<!--            <label for="userName">用户名：</label>-->
            <?php echo $form->labelEx($login_model,'name'); ?>
        </div>
        <div class="controls">
<!--            <input type="text" id="userName" name="username" required="required" />-->
            <?php echo $form->textField($login_model,'name',array('required'=>'required')); ?>
            <?php echo $form->error($login_model,'name'); ?>
        </div>
    </div>
    <div class="control-group">
        <div class="control-label">
...
<!--            <input type="password" id="userPsw" name="password" required="required" />-->
            <?php echo $form->textField($login_model,'password',array('required'=>'required')); ?>
